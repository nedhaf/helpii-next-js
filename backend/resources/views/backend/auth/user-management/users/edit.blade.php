                    ...
                    <div class="col-md-1">
                        ...
                        <div class="mt-1 mb-0">
                            <label class="switch switch-lg">
                                <input type="checkbox" class="switch-input" name="active" id="active" value="1" checked>
                    ...
                    <div class="col-md-1">
                        ...
                        <div class="mt-1 mb-0">
                            <label class="switch switch-lg switch-success">
                                <input type="checkbox" class="switch-input" name="confirmed" id="confirmed" value="1" checked>
