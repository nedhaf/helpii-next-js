...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact " dir="ltr" data-theme="theme-default" data-assets-path="../Backend/assets/" data-template="vertical-menu-template">
    ...
    <head>
        ...
        <title>Helpii | @yield('head-title')</title>
                        ...
                        <footer class="content-footer footer bg-footer-theme">
                            <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                                <div class="mb-2 mb-md-0">
                                    <strong>{{ __('Copyright') }} © <script>document.write(new Date().getFullYear()) </script> <a href="https://www.helpii.se/" target="_blank" class="footer-link fw-medium text-primary">Helpii</a></strong>
                                </div>
                                <div class="d-none d-lg-inline-block">
                                    <strong>{{ __('Created By') }}</strong>
                                    <a href="https://raindrops.se/" class="footer-link me-4" target="_blank"><img src="{{ asset('images/raindrops-se-icon.png') }}" /></a>
