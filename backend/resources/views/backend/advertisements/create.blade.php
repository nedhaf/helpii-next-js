...
@section('head-title', 'Create Advertisement')
...
<div class="row">
    <section class="col-lg-12">
        <div class="card mb-4">
            <form class="card-body" method="post" action="{{ route('administrator.backend_store_advertisement') }}" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <div class="col-md-4">
                        <label class="form-label" for="title">Title</label>
                        <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="John" value="{{ old('title') }}"/>
                        @error('title')
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="tel" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone') }}" placeholder="12345 67890">
                        @error('phone')
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="city" id="city" class="form-control @error('city') is-invalid @enderror" placeholder="abcd" value="{{ old('city') }}"/>
                        @error('city')
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="link" id="link" class="form-control @error('link') is-invalid @enderror" placeholder="https://www.google.com/" value="{{ old('link') }}"/>
                        @error('link')
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="start_date" id="start_date" placeholder="YYYY/MM/DD" class="form-control start_date @error('start_date') is-invalid @enderror" value="{{ old('start_date') }}" />
                        @error('start_date')
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="end_date" id="end_date" placeholder="YYYY/MM/DD" class="form-control end_date @error('end_date') is-invalid @enderror" value="{{ old('end_date') }}"/>
                        @error('end_date')
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="cost" id="cost" class="form-control @error('cost') is-invalid @enderror" placeholder="0.00" value="{{ old('cost') }}"/>
                        @error('cost')
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="form-select @error('city') is-invalid @enderror" name="position" id="position">
                            ...
                            <option value="after_5">After 5</option>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid rounded me-3 justify-content-center" src="{{ old('image') ?? asset('storage/no_img.jpeg')}}" height="100" width="100" alt="no_img" id="uploadedAdvrtImg"/>
                            ...
                            <div class="button-wrapper">
                                ...
                                <button type="button" class="btn btn-label-secondary img-image-reset mb-2" disabled>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid rounded me-3 justify-content-center" src="{{ old('badge_img') ?? asset('storage/no_img.jpeg')}}" height="100" width="100" alt="no_img" id="uploadedBadgeImg"/>
