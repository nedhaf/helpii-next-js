<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="light-style layout-wide  customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="../Backend/assets/" data-template="vertical-menu-template">
    <head>
        <meta charset="utf-8" />
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="app-brand justify-content-center">
                                <a href="{{ route('administrator.backend_login') }}" class="app-brand-link gap-2">
                            ...
                            @endif
                            <form id="formAuthentication" class="mb-3" action="{{ route('administrator.backend_login') }}" method="post">
                                @csrf
                                <div class="mb-3">
