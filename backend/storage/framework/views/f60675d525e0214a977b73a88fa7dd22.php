<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="light-style layout-wide  customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="../Backend/assets/" data-template="vertical-menu-template">
    <head>
        <meta charset="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />
        <title>Helpii | Administrator LogIn</title>
        ...
        <!-- Vendor -->
        <link rel="stylesheet" href="<?php echo e(asset('Backend/assets/vendor/libs/@form-validation/umd/styles/index.min.css')); ?>" />
        <!-- Page CSS -->
        <!-- Page -->
        <link rel="stylesheet" href="<?php echo e(asset('Backend/assets/vendor/css/pages/page')); ?>-auth.css">
        <!-- Helpers -->
        <script src="<?php echo e(asset('Backend/assets/vendor/js/helpers.js')); ?>"></script>
        <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
        <!--? Template customizer: To hide customizer set displayCustomizer value false in config.js.  -->
        <script src="<?php echo e(asset('Backend/assets/vendor/js/template-customizer.js')); ?>"></script>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="app-brand justify-content-center">
                                <a href="<?php echo e(route('administrator.backend_login')); ?>" class="app-brand-link gap-2">
                            ...
                            <?php endif; ?>
                            <form id="formAuthentication" class="mb-3" action="<?php echo e(route('administrator.backend_login')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
        ...
        <!-- endbuild -->
        <!-- Vendors JS -->
        <script src="<?php echo e(asset('Backend/assets/vendor/libs/@form-validation/umd/bundle/popular.min.js')); ?>"></script>
        <script src="<?php echo e(asset('Backend/assets/vendor/libs/@form-validation/umd/plugin-bootstrap5/index.min.js')); ?>"></script>
        <script src="<?php echo e(asset('Backend/assets/vendor/libs/@form-validation/umd/plugin-auto-focus/index.min.js')); ?>"></script>
        <!-- Main JS -->
        <script src="<?php echo e(asset('Backend/assets/js/main.js')); ?>"></script>
        <!-- Page JS -->
        <script src="<?php echo e(asset('Backend/assets/js/pages-auth.js')); ?>"></script>
    </body>
    <!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/auth-login-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Jan 2024 10:03:39 GMT -->
</html>
<!-- beautify ignore:end --><?php /**PATH /var/www/html/staging.helpii.se/backend/resources/views/backend/authentications/login.blade.php ENDPATH**/ ?>