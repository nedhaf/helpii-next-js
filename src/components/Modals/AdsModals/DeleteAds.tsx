...
export default function DeleteAds({ userDetails, adsId }) {
    ...
    async function deleteCurrentAds(e, id) {
        e.preventDefault();
        ...
        await axios.post(getPublicUrl+'/api/delete-ad', formdata, config).then(response => {
    ...
    return (
        <>
            <button type={`button`} className="delete-button" data-bs-toggle="modal" data-bs-target={`#deleteAdsModal-${adsId}`}>
                <img src={`${getPublicUrl}/images/delete-icon.png`} alt="delete-ads" />
            </button>

            <div className="modal fade" id={`deleteAdsModal-${adsId}`} tabIndex="-1" aria-labelledby={`deleteAdsModalLabel-${adsId}`} aria-hidden="true">
                        ...
                        <div className="modal-body">
                            <div className={`row`}>
                                <div className={`col-md-12`}>
                                    <h5 className={'helpii-texts mb-4'}>Är du säker på att du vill ta bort den här annonsen?</h5>
                                    ...
                                    <div className={`d-flex justify-content-center gap-5`}>
                                        <button type="button" className="yes-button outline-primary" onClick={(e) => deleteCurrentAds(e, adsId)}>Yes</button>
