...
const popover = (
    <Popover id="popover-basic">
        <Popover.Header as="h3" className="text-danger">Maximum number of skills has been reached.</Popover.Header>
        <Popover.Body>
            Apologies for the confusion! You've already reached the limit of four skills. If you wish to add a new one, please <strong>Remove</strong> an existing skill first.
        </Popover.Body>
    </Popover>
);

export default function CreateSkill({ userDetails, userSkills }) {
    ...
    // if( selectedPriceOption == 'both' ) {
    //     // pricePerDay pricePerHour
    //     console.log('Price Both of perday : ', pricePerDay);
    //     console.log('Price Both of perhour : ', pricePerHour);
    // } else {
    //     console.log('Price of perday : ', pricePerDay);
    //     console.log('Price of perhour : ', pricePerHour);
    // }
    ...
    const handleNextClick = () => {
        if (!selectedSkill) {
            setShowError(true);
            return; // Prevent modal opening and unnecessary rendering
        }
    };
    ...
    async function handleSubmit(e) {
        ...
        await axios.post(getPublicUrl+'/api/create-spskills', formdata, config).then(response => {
    ...
    return (
        <>
            ...
            { userSkills.length >= 4 ? (<>
                ...
                <button type={`button`} className="add-button" data-bs-toggle="modal" data-bs-target={`#skillModal`}>
                    <img src={getPublicUrl+"/images/plus-icon.png"} alt="profile-button" />Nytt
                </button>
            </>)}

            {/*Skill Select Modal*/}
            <div className="modal fade" id="skillModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div className="modal-body">
                            ...
                            <Form onSubmit={handleSubmit}>
                                ...
                                <div className={`user-availability-btns mt-3 d-flex justify-content-center gap-5`}>
                                    ...
                                    <button type="button" className="save-button outline-primary" data-bs-target="#descriptionModal" data-bs-toggle="modal" disabled={!selectedSkill}>Next</button>
                                </div>
                            </Form>
                        </div>
                    </div>
            ...
            <div className="modal fade" id="descriptionModal" aria-hidden="true" aria-labelledby="skill-description-modal" tabIndex="-1">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <Form onSubmit={handleSubmit}>
                                ...
                                <div className={`user-availability-btns mt-3 d-flex justify-content-center gap-5`}>
                                    {/*<button type="submit" className="save-button outline-primary" disabled={isLoading || !selectedSkill || !errors}>{isLoading ? 'Confirming...' : 'Next'}</button>*/}
                                    <button type="button" className="save-button outline-primary" data-bs-target="#skillModal" data-bs-toggle="modal">Previous</button>
                                    <button type="button" className="save-button outline-primary" data-bs-target="#tagsModal" data-bs-toggle="modal" disabled={!skillDescription}>Next</button>
                                </div>
                            </Form>
                        </div>
                    </div>
            ...
            {/*Skill tags Modal*/}
            <div className="modal fade" id="tagsModal" aria-hidden="true" aria-labelledby="skill-tags-modal" tabIndex="-1">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        ...
                        <div className="modal-body">
                            <Form onSubmit={handleSubmit}>
                                ...
                                <div className={`user-availability-btns mt-3 d-flex justify-content-center gap-5`}>
                                    {/*<button type="submit" className="save-button outline-primary" disabled={isLoading || !selectedSkill || !errors}>{isLoading ? 'Confirming...' : 'Next'}</button>*/}
                                    <button type="button" className="save-button outline-primary" data-bs-target="#descriptionModal" data-bs-toggle="modal">Previous</button>
                                    <button type="button" className="save-button outline-primary" data-bs-target="#skillPrice" data-bs-toggle="modal" disabled={!tags.length}>Next</button>
                                </div>
                            </Form>
                        </div>
                    </div>
            ...
            {/*Skill Pricing Modal*/}
            <div className="modal fade" id="skillPrice" aria-hidden="true" aria-labelledby="skill-price-modal" tabIndex="-1">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        ...
                        <div className="modal-body">
                            <Form onSubmit={handleSubmit}>
                                ...
                                <div className={`user-availability-btns mt-3 d-flex justify-content-center gap-5`}>
                                    {/*<button type="submit" className="save-button outline-primary" disabled={isLoading || !selectedSkill || !errors}>{isLoading ? 'Confirming...' : 'Next'}</button>*/}
                                    <button type="button" className="save-button outline-primary" data-bs-target="#tagsModal" data-bs-toggle="modal">Previous</button>
                                    <button type="button" className="save-button outline-primary" data-bs-target={isDiscounted ? `#skillDiscount` : `#skillAddress`} data-bs-toggle="modal">Next</button>
                                </div>
                            </Form>
                        </div>
                    </div>
            ...
            <div className="modal fade" id="skillDiscount" aria-labelledby="skill-discount-modal">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        ...
                        <div className="modal-body">
                            <Form>
                                ...
                                <div className={`user-availability-btns mt-3 d-flex justify-content-center gap-5`}>
                                    {/*<button type="submit" className="save-button outline-primary" disabled={isLoading || !selectedSkill || !errors}>{isLoading ? 'Confirming...' : 'Next'}</button>*/}
                                    <button type="button" className="save-button outline-primary" data-bs-target="#skillPrice" data-bs-toggle="modal">Previous</button>
                                    <button type="button" className="save-button outline-primary" data-bs-target="#skillAddress" data-bs-toggle="modal">Next</button>
                                </div>
                            </Form>
                        </div>
                    </div>
            ...
            {/*Skill Address Modal*/}
            <div className="modal fade" id="skillAddress" aria-labelledby="skill-address-modal">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        ...
                        <div className="modal-body">
                            <Form onSubmit={handleSubmit}>
                                ...
                                <div className={`user-availability-btns mt-3 d-flex justify-content-center gap-5`}>
                                    ...
                                    {/*<button type="submit" className="save-button outline-primary" disabled={isLoading || !selectedSkill || !errors}>{isLoading ? 'Confirming...' : 'Next'}</button>*/}
                                    <button type="button" className="save-button outline-primary" data-bs-target={isDiscounted ? `#skillDiscount` : `#skillPrice`} data-bs-toggle="modal">Previous</button>
